            ...
            <main className={styles.authContainer}>
                <article class="card">
                    ...
                    <form ref={this.form}>
                        ...
                        <ValidatedInput type="text" className={styles.textInput} onChange={e => this.setState({name: e.target.value})}
                            ref={this.nameInput} required
                        >
                            Display Name
                        </ValidatedInput>
...
export default withRouter(FinalizeAccount);
